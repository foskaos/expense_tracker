...
import datetime
from period import Period, last_working_day
...
class LastWorkingDayMonthlyExpenseSchedule(ExpenseSchedule):
...
schedule_menu_selections = {'a':AnchoredExpenseSchedule,
                            'l':LastWorkingDayMonthlyExpenseSchedule,
                            'w':WeeklyExpenseSchedule}
